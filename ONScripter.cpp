...
void ONScripter::initSDL()
{
    ...
    window = SDL_CreateWindow(NULL, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, screen_device_width, screen_device_height, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
#else
	...
	#if defined(_MSC_VER) && _MSC_VER <= 1200
	#endif
    int len = strlen(wm_title_string);
